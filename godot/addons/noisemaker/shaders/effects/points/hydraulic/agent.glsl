...
layout(set = 0, binding = 4) uniform sampler2D inputTex;  // Source texture for gradient descent
layout(set = 0, binding = 1) uniform sampler2D xyzTex;    // [x, y, z, alive]
layout(set = 0, binding = 2) uniform sampler2D velTex;    // [x_dir, y_dir, inertia, 0]
