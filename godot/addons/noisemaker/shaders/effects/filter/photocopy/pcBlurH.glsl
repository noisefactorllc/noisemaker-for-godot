#version 450
// filter/photocopy, program "pcBlurH" — ported verbatim from wgsl/pcBlurH.wgsl
// (same shape as filter/relief's rlBlurH; radius driven by `detail`:
// mix(1,24,(detail-1)/99)). No-layout effect: the backend synthesizes the
