#version 450
layout(set = 0, binding = 0, std140) uniform Params { vec4 data[5]; } _ubo;
#define imageSize _ubo.data[4].xy
#define resolution _ubo.data[0].xy
#define time _ubo.data[0].z
#define position int(_ubo.data[1].x)
#define rotation _ubo.data[1].y
#define scaleAmt _ubo.data[1].z
#define offsetX _ubo.data[1].w
#define offsetY _ubo.data[2].x
#define tiling int(_ubo.data[2].y)
#define flip int(_ubo.data[2].z)
#define bgColor _ubo.data[3].xyz
#define bgAlpha _ubo.data[2].w
