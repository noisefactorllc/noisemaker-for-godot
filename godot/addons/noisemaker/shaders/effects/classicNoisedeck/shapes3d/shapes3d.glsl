#version 450
layout(set = 0, binding = 0, std140) uniform Params { vec4 data[12]; } _ubo;
#define time _ubo.data[0].z
#define resolution _ubo.data[0].xy
#define tileOffset _ubo.data[11].xy
#define fullResolution _ubo.data[11].zw
#define shapeAScale _ubo.data[1].z
#define shapeBScale _ubo.data[1].w
#define shapeAThickness _ubo.data[2].x
#define shapeBThickness _ubo.data[2].y
#define smoothness _ubo.data[2].w
#define spin _ubo.data[3].x
#define flip int(_ubo.data[3].y)
#define spinSpeed _ubo.data[3].z
#define flipSpeed _ubo.data[3].w
#define repetition (_ubo.data[4].x != 0.0)
#define animation int(_ubo.data[4].y)
#define flythroughSpeed _ubo.data[4].z
#define spacing int(_ubo.data[4].w)
#define cameraDist _ubo.data[5].x
#define bgColor _ubo.data[6].xyz
#define bgAlpha _ubo.data[5].y
#define colorMode int(_ubo.data[5].z)
#define paletteMode int(_ubo.data[6].w)
#define paletteOffset _ubo.data[7].xyz
#define paletteAmp _ubo.data[8].xyz
#define paletteFreq _ubo.data[9].xyz
#define palettePhase _ubo.data[10].xyz
#define cyclePalette int(_ubo.data[7].w)
#define rotatePalette _ubo.data[8].w
#define repeatPalette int(_ubo.data[9].w)
#define weight _ubo.data[5].w
