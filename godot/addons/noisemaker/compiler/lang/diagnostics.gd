...
const _TABLE := {
	...
	"P005": ["Invalid output operation", "error", "parser"],
	"P006": ["Invalid subchain", "error", "parser"],
	"P007": ["Invalid call expression", "error", "parser"],
	"P008": ["Unknown subchain argument key", "warning", "parser"],
	"P009": ["Duplicate subchain argument key", "warning", "parser"],
	"P010": ["Missing ',' between subchain arguments", "warning", "parser"],
